 ...
 */
export function calculateDetailedWaterfall(shareClasses, transactions, exitAmount) {
  let results = [];
 ...
 */
export function calculateSummaryWaterfall(shareClasses, transactions, exitAmount) {
 ...
 */
export function calculateExitDistribution(shareClasses, transactions, maxExitAmount, numPoints = 20) {
 ...
 */
export function getShareClassColor(className, index, alpha = 1) {
  const colors = {
 ...
 * @returns {string} - CSS color string
 */
export function getDistributionTypeColor(type, alpha = 1) {
...
export const DEFAULT_SHARE_CLASSES = [
